    ...
    <Fragment>
      <motion.nav 
        className={`fixed w-full top-0 z-50 transition-all duration-300 ${
          scrolled ? "bg-black/95 backdrop-blur-md py-2 shadow-xl" : "bg-black/90 backdrop-blur-sm py-4"
        }`}
        initial={{ y: -100 }}
        animate={{ y: 0 }}
        ...
        <div className="container mx-auto px-6 flex justify-between items-center">
          ...
          >
            <div className="relative">
              <IoLogoAmplify
                className="text-red-600 text-3xl relative z-10 transition-all duration-300 group-hover:drop-shadow-[0_0_15px_#ff2e2e]"
              />
              <span className="absolute inset-0 rounded-full border-2 border-red-600 opacity-0 group-hover:opacity-100 group-hover:scale-125 transition-all duration-500 blur-md"></span>
            </div>
                ...
                >
                  <a
                    ...
                    className="relative text-white text-lg font-medium transition-all duration-300
                               ...
                               group-hover:bg-gradient-to-r group-hover:from-red-600 group-hover:to-white
                               group-hover:drop-shadow-[0_0_8px_#ff2e2e] p-1"
                  >
                    {item.name}
                    <span className="absolute left-0 bottom-0 w-0 h-0.5 bg-gradient-to-r from-red-600 to-white transition-all duration-500 ease-out group-hover:w-full"></span>
                    <span className="absolute right-0 top-0 w-0 h-0.5 bg-gradient-to-r from-white to-red-600 transition-all duration-500 ease-out group-hover:w-full"></span>
          ...
          <div className="hidden lg:block">
            ...
            >
              <a
                href="#contact"
                className="flex items-center gap-2 bg-red-600 text-white px-6 py-2 rounded-full font-semibold relative z-10 overflow-hidden shadow-lg"
              >
                Contact
              </a>
              ...
              <span className="absolute inset-0 rounded-full border-2 border-red-600 opacity-0 group-hover:opacity-100 group-hover:scale-110 transition-all duration-500 ease-out blur-md"></span>
            </motion.div>
          </div>
          ...
          >
            {isMenuOpen ? (
              <IoCloseSharp className="text-3xl text-red-600" />
            ) : (
