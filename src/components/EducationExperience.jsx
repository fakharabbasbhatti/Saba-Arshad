                ...
                {education.map((item, index) => (
                  <div key={index} className="relative group">
                    ...
                    <div
                      ...
                      className="bg-black p-6 rounded-3xl border border-red-600/40 hover:border-red-600 transition-all duration-500 hover:-translate-y-3 hover:shadow-2xl hover:shadow-red-600/50"
                    >
                      <h3
                        data-aos="flip-left"
